...
| Test suite               | 🟢 `FULLY_FUNCTIONAL` | 248 top-level test/benchmark/fuzz functions across 34 test files, all passing with `-race` (counted via `rg -c '^func (Test\|Benchmark\|Fuzz)' *_test.go`)                                                                                                           |
