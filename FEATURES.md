...
| Test suite               | 🟢 `FULLY_FUNCTIONAL` | 274 top-level test/benchmark/fuzz functions across 38 test files, all passing with `-race` (counted via `rg -c '^func (Test\|Benchmark\|Fuzz)' *_test.go`)                                                                                                           |
