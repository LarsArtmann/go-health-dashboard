...
| Test suite               | 🟢 `FULLY_FUNCTIONAL` | 185 top-level test/benchmark/fuzz functions across 20 test files, all passing with `-race` (counted via `rg -c '^func (Test\|Benchmark\|Fuzz)' *_test.go`)                                                                                                                                                                                     |
