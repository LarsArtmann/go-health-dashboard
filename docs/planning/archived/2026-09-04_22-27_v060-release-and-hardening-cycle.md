...
| ------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Push master and cut v0.6.0** (watch CI, re-head CHANGELOG, bump `Version` in the tag commit, tag + push, proxy-verify) | Two days of shipped value (CI hardening, sentinels, sanitize fix, docs) sit unreleased; the push _activates_ the version-guard/floor/concurrency jobs for their first real run, converts "locally validated" into "verified", and unblocks the GitHub-Releases and pin-lift work. One push; half the open risk gone. |
...
| D3  | AGENTS.md prune pass toward ~18 KB (grow-and-prune rule) _(Open — AGENTS.md has only grown; prune parked as M113 of the 2026-09-17 pareto plan, a dedicated own-session task.)_                                                                                                                                                        | 60min                                                                                                        | Low    | Med    | Low         | —           |
