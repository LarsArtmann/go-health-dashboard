...
**Status (2026-09-18, annotated)**: the 1% (M1–M2), the full v0.9.0 release chain (M3–M18), the 4%
integrity tier (M19–M21), and the 20% quality/tests/docs tier (M22–M59 incl. the M54–M56 design
note and the M75–M79 CI automation, plus M80–M94) are DONE — see the inline `done at` markers in
Step 3. Still open: the tail M60–M74 (fleet/upstream/hygiene), M88–M92, M95–M111 (routed to
TODO_LIST/ROADMAP by the 2026-09-18 docs-health pass), and the user-decision gates M112–M120
(BLOCKED on answers, untouched by design).
...
| ~~M54~~  | ~~Timeline-from-Since design doc: restart semantics, aggregates, reset behavior~~ done — design note landed (6a0f3bb): docs/design/2026-09-17_since-fed-timeline-stability-staleness.md                                                                                      | ~~12~~ | ~~C23~~ |
| ~~M55~~  | ~~Stable-group collapse design (ages from Since) + ROADMAP update; commit~~ done — design note landed (6a0f3bb); ROADMAP Themes 2/3 carry the ideas                                                                                                                          | ~~12~~ | ~~C23~~ |
| ~~M56~~  | ~~Per-source staleness design note (Since-based, aggregate worst-of)~~ done — design note landed (6a0f3bb)                                                                                                                                                                   | ~~12~~ | ~~—~~   |
...
| ~~M75~~  | ~~CI: actionlint both workflow files; fix findings~~ done at `0b86039`                                                                                                                                                                                                       | ~~12~~ | ~~—~~   |
| ~~M76~~  | ~~CI: `nix flake check` job + Go version matrix (two latest 1.26.x)~~ done at `0b86039`                                                                                                                                                                                      | ~~12~~ | ~~—~~   |
| ~~M77~~  | ~~CI: auto-draft GitHub Release from CHANGELOG section on tag push~~ done at `0b86039`                                                                                                                                                                                       | ~~12~~ | ~~—~~   |
| ~~M78~~  | ~~CI: upload browser screenshots as artifacts (+ dark-degraded capture variant)~~ done at `0b86039`                                                                                                                                                                          | ~~12~~ | ~~—~~   |
| ~~M79~~  | ~~CI: Dependabot config grouping the templ-components family modules~~ done at `0b86039`                                                                                                                                                                                     | ~~10~~ | ~~—~~   |
