...
### Decision Gates (BLOCKED — need user input)

| ID  | Decision                                  | Blocks                              | Default if no answer          |
| --- | ----------------------------------------- | ----------------------------------- | ----------------------------- |
| D1  | LICENSE: Proprietary or MIT?              | Semantic versioning, public release | Keep PROPRIETARY, fix README  |
| D2  | Replace directives: keep or tag upstream? | External `go get`, public release   | Keep for now, document loudly |
| D3  | GOEXPERIMENT=jsonv2: accept or gate?      | Build-tag gating task               | Accept and document           |
