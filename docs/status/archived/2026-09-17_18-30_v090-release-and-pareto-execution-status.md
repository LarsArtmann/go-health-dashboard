...
| #     | Work                                                                                                                                      | Done                                                                                                                                                                                                                                                                                                                    | Missing                                                                                                                                                                                                                                                                     |
| ----- | ----------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ~~1~~ | ~~**C6 — README screenshots showing per-check metadata**~~ done — captures taken and eyeballed (fca3ed3 light+dark, 3fdac18 degraded)     | ~~Fixture upgraded: `timedScreenshotRecorder` (implements `HealthRecorder` + `DetailedHealthRecorder`, per-check `time.Since` measurement) wired into BOTH capture probes so the screenshots can show since/age **and** duration; vet clean; env var names discovered (`SCREENSHOT_OUTPUT`, `SCREENSHOT_OUTPUT_DARK`)~~ | ~~Captures **not taken** (first light run skipped — env var wasn't set), PNGs not regenerated, not eyeballed. The fixture commit got swept by the daemon (`29c5d69`, heuristic message, now permanent on origin) and briefly went CI-red until `b6de6e7` canonicalized it~~ |
| ~~2~~ | ~~**Pareto-plan bookkeeping**~~ done — the plan is annotated (5adbc67, ae7b820 + 2026-09-18 pass); satisfied TODO rows moved to CHANGELOG | ~~M1–M21 executed~~                                                                                                                                                                                                                                                                                                     | ~~The plan doc has **zero inline annotations** yet (docs-health ANNOTATE mode for M1–M21 disposition); TODO_LIST still carries rows this session satisfied (dependabot merge row, screenshot row wording)~~                                                                 |
| ~~3~~ | ~~**CHANGELOG for post-release commits**~~ done — [Unreleased] carries the batch entries                                                  | ~~`[Unreleased]` section exists (fresh, empty)~~                                                                                                                                                                                                                                                                        | ~~No entries yet for the client_model bump, the histogram test, or the upcoming screenshot refresh — batch-level entries unwritten (interacts with the unblessed append-only carve-out from the morning audit)~~                                                            |
| ~~4~~ | ~~**4% integrity tier**~~ done — C6 closed; the 4% tier is complete                                                                       | ~~C3 ✓ C4 ✓ C5 ✓ C7 ✓~~                                                                                                                                                                                                                                                                                                 | ~~C6 (above) — the tier's last task~~                                                                                                                                                                                                                                       |
...
| #      | Task                                                                                                                                                                                                          | Source                                           |
| ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| ~~1~~  | ~~Finish C6: capture light + dark screenshots (env names now known), EYEBALL both PNGs, commit with intent message~~ done at `fca3ed3`, `3fdac18`                                                             | ~~C6~~                                           |
| ~~2~~  | ~~Annotate the pareto plan (M1–M21 dispositions, inline)~~ done — (5adbc67, ae7b820; continued 2026-09-18)                                                                                                    | ~~bookkeeping~~                                  |
| ~~3~~  | ~~TODO_LIST: close the dependabot row + refresh the screenshot row~~ done — closed rows moved to CHANGELOG in later rebuilds                                                                                  | ~~bookkeeping~~                                  |
| ~~4~~  | ~~CHANGELOG `[Unreleased]`: entries for client_model bump + histogram test~~ done — [Unreleased] carries them                                                                                                 | ~~bookkeeping~~                                  |
| ~~5~~  | ~~M22: SSE patch-content test — patch payload carries the metadata line~~ done at `c26ef9c`                                                                                                                   | ~~C8~~                                           |
| ~~6~~  | ~~M23: extend to evidence-strip line + since text assertions~~ done at `ee5dda1`                                                                                                                              | ~~C8~~                                           |
| ~~7~~  | ~~M24: run `BenchmarkHandler_HTMLRendering` (stamping-loop numbers)~~ done at `52f140c`                                                                                                                       | ~~C9~~                                           |
| ~~8~~  | ~~M25: record results in `docs/research/2026-09-10_benchmarks.md`; commit~~ done at `52f140c`                                                                                                                 | ~~C9~~                                           |
| ~~9~~  | ~~M26: aggregate metadata integration test (stub + detailed sources)~~ done at `c26ef9c`                                                                                                                      | ~~C10~~                                          |
| ~~10~~ | ~~M27: assert since/duration transit the aggregate path; commit~~ done at `c26ef9c`                                                                                                                           | ~~C10~~                                          |
| ~~11~~ | ~~M28: fuzz seeds for `formatCheckDuration`/`formatStateAge` (negative/huge/sub-µs)~~ done at `6789a5e`                                                                                                       | ~~C11~~                                          |
| ~~12~~ | ~~M29: 60s fuzz runs on the two formatters; record; commit~~ done at `ff67ff7`                                                                                                                                | ~~C11~~                                          |
| ~~13~~ | ~~M30: public-mode golden fixture (`-golden-update` flow)~~ done at `d04865d`                                                                                                                                 | ~~C12~~                                          |
| ~~14~~ | ~~M31: dark-mode + zero-proven-warning goldens; review diffs line-by-line~~ done — zero-proven golden d04865d; dark fixture N/A (CSS-class-only theming); covered by the dark screenshot                      | ~~C12~~                                          |
| ~~15~~ | ~~M32: CSP asserts on new goldens (`title=""`, no `style=`); commit~~ done at `d04865d`                                                                                                                       | ~~C12~~                                          |
| ~~16~~ | ~~M33: dark-mode axe pass (extend `TestBrowser_Accessibility`)~~ done at `cacd7d4`, `3a8e104`                                                                                                                 | ~~C13~~                                          |
| ~~17~~ | ~~M34: fix or evidence-document any serious/critical axe finding~~ done — zero serious/critical findings in both themes; nothing to fix                                                                       | ~~C13~~                                          |
| ~~18~~ | ~~M35: example server — `DetailedHealthRecorder`-backed service~~ done at `cacaca0`                                                                                                                           | ~~C14~~                                          |
| ~~19~~ | ~~M36: example footer Version + shutdown-path exercise~~ done at `cacaca0`, `d0dd504`                                                                                                                         | ~~C14~~                                          |
| ~~20~~ | ~~M37: example README rows; commit~~ done at `ba720f9`                                                                                                                                                        | ~~C14~~                                          |
| ~~21~~ | ~~M38: SECURITY.md (reporting contact, supported versions, disclosure note)~~ done at `ba720f9`                                                                                                               | ~~C15~~                                          |
| ~~22~~ | ~~M39: link SECURITY.md from README~~ done at `ba720f9`                                                                                                                                                       | ~~C15~~                                          |
| ~~23~~ | ~~M40: README "Upgrading" section (WithBasePath/fingerprint/metadata notes)~~ done at `ba720f9`                                                                                                               | ~~C16~~                                          |
| ~~24~~ | ~~M41: review pass + link sweep~~ done at `ba720f9`                                                                                                                                                           | ~~C16~~                                          |
| ~~25~~ | ~~M42: CONTRIBUTING "Guard scripts" section~~ done at `ba720f9`                                                                                                                                               | ~~C17~~                                          |
| ~~26~~ | ~~M43: CONTRIBUTING desk-gate + release-checklist pointer~~ done at `ba720f9`                                                                                                                                 | ~~C17~~                                          |
| ~~27~~ | ~~M44: CHANGELOG historical audit — diff sections against their tags~~ done at `d7e0e33`                                                                                                                      | ~~C18~~                                          |
| ~~28~~ | ~~M45: relocate misplaced `[0.1.0-alpha]` bullets; changelog lint~~ done at `d7e0e33`                                                                                                                         | ~~C18~~                                          |
| ~~29~~ | ~~M46: dep-bump verification checklist draft~~ done at `671de9e`                                                                                                                                              | ~~C19~~                                          |
| ~~30~~ | ~~M47: land it (AGENTS bullet or `scripts/verify-dep-bump.sh`)~~ done at `671de9e`                                                                                                                            | ~~C19~~                                          |
| ~~31~~ | ~~M48: DOMAIN_LANGUAGE evidence terms (proven/unproven/window)~~ done at `3098ff5`                                                                                                                            | ~~C20~~                                          |
| ~~32~~ | ~~M49: DOMAIN_LANGUAGE bootstrap/stacking/contrast terms~~ done at `3098ff5`                                                                                                                                  | ~~C20~~                                          |
| ~~33~~ | ~~M50: ROADMAP v1.0 criteria section~~ done at `ba720f9`                                                                                                                                                      | ~~C21~~                                          |
| ~~34~~ | ~~M51: README "Stability" cross-link~~ done at `ba720f9`                                                                                                                                                      | ~~C21~~                                          |
| ~~35~~ | ~~M52: evidence tooltips cite `Check.When`… i.e. `Check.Since` when present~~ done at `a881f21`                                                                                                               | ~~C22~~                                          |
| ~~36~~ | ~~M53: update evidence tests + goldens; browser suite; commit~~ done at `a881f21`, `3ea1d9a`                                                                                                                  | ~~C22~~                                          |
| ~~37~~ | ~~M54: timeline-from-`Since` design doc (restart semantics)~~ done — design note landed (6a0f3bb)                                                                                                             | ~~C23~~                                          |
| ~~38~~ | ~~M55: stable-group collapse design + ROADMAP update~~ done — design note landed (6a0f3bb); ROADMAP updated                                                                                                   | ~~C23~~                                          |
| ~~39~~ | ~~M56: per-source staleness design note~~ done — design note landed (6a0f3bb)                                                                                                                                 | ~~tail~~                                         |
| ~~40~~ | ~~M57: `/health/export` since/duration design note (wire stability)~~ done — implemented directly (a881f21); decision in handler doc + AGENTS bullet                                                          | ~~tail~~                                         |
| ~~41~~ | ~~M58: `deploy/` audit — Grafana/monitoring inventory, gauge-panel gap~~ done — audited; a full Grafana stack landed later (3b03c23)                                                                          | ~~tail~~                                         |
| ~~42~~ | ~~M59: Grafana panel JSON for the duration gauge (if assets exist)~~ **Won't implement — superseded — a provisioned Grafana stack landed (3b03c23; live-verified 2026-09-18) rather than a lone panel JSON.** | ~~tail~~                                         |
| 43     | M72: `~/go/bin` prune vs repo HEAD + rotate `/tmp/bf-*.log`                                                                                                                                                   | tail _(Open — hygiene, unrouted.)_               |
| 44     | M73: buildflow on-demand `-s gitleaks` + `-s codespell`; record                                                                                                                                               | tail _(Open — on-demand steps, never run here.)_ |
| 45     | M74: `buildflow timings --regressions` baseline                                                                                                                                                               | tail _(Open — small idea, unrouted.)_            |
| ~~46~~ | ~~M75: actionlint both workflow files; fix findings~~ done at `0b86039`                                                                                                                                       | ~~tail~~                                         |
| ~~47~~ | ~~M76: CI `nix flake check` job + Go version matrix~~ done at `0b86039`                                                                                                                                       | ~~tail~~                                         |
| ~~48~~ | ~~M77: CI auto-draft GitHub Release from the CHANGELOG section on tag push~~ done at `0b86039`                                                                                                                | ~~tail~~                                         |
| ~~49~~ | ~~M78: CI uploads browser screenshots as artifacts~~ done at `0b86039`                                                                                                                                        | ~~tail~~                                         |
| ~~50~~ | ~~M79: Dependabot config grouping the templ-components family~~ done at `0b86039`                                                                                                                             | ~~tail~~                                         |
...
1. ~~**Push cadence for the remaining batches**: per-batch pushes (CI sees everything immediately;~~ done (answered — per-batch pushes with CI verification became the norm)
...
2. ~~**README screenshot content**: the new capture fixture measures REAL durations (rendering as e.g.~~ done (answered — real measured values shipped (fca3ed3))
...
3. **CHANGELOG granularity for housekeeping commits** (dep bumps, test-only batches): an _(Open — user ratification pending; the rich-prose pattern is the working norm.)_
