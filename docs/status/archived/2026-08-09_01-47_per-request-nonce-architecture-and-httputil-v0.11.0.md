...
Correct as-is. go-health-dashboard is a rendering library; httputil is HTTP middleware (30+ files). The dashboard needs a nonce _string value_, not nonce generation infrastructure. Coupling would drag the entire middleware stack as transitive deps.
