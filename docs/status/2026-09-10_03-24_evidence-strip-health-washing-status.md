...
_Point-in-time snapshot at `6b1bea9`. Section (f) is HARVEST-ready; per the status-report skill, TODO_LIST.md/ROADMAP.md should be updated from it when work resumes._
