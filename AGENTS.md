...
**Module**: `github.com/larsartmann/go-health-dashboard` · **Package**: `dashboard` · **Go**: 1.26.5 · **Status**: v0.2.0
...
dashboard.go     — Dashboard struct, Config, Option type, New(), WithTitle/WithPushInterval/WithPushMode/WithNonce/WithNonceExtractor/WithRoutes/WithCSSPath/WithHeartbeatInterval/WithMaxSSEConnections/WithRetryInterval/WithBasePath, Handler(), SSEHandler(), SubscriberCount(), RegisterRoutes(mux), Start(), Shutdown(), HealthCheck()
