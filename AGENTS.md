...
dashboard.go     — Dashboard struct, Config, Option type, New(), WithTitle/WithPushInterval/WithPushMode/WithNonce/WithRoutes/WithCSSPath/WithHeartbeatInterval/WithMaxSSEConnections, Handler(), SSEHandler(), SubscriberCount(), RegisterRoutes(), Start(), Shutdown()
