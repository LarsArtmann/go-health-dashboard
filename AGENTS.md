...
**Module**: `github.com/larsartmann/go-health-dashboard` · **Package**: `dashboard` · **Go**: 1.26.5 · **Status**: v0.4.0
...
Test files (19 `_test.go` files): notable ones are `browser_test.go`
(chromedp runtime CSP, serialized Chrome launches), `screenshot_test.go` /
