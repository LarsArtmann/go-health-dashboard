...
| ~~Toolchain bump go1.26.7 → 1.26.8 via verify-dep-bump.sh~~ | ✅ `CLOSED` | Overtaken by events: go.mod's floor is `go 1.27.1` (dep-driven, 2026-09-19) and CI's matrix pins 1.27.1 — there is no 1.26.x alignment left to do; `check-go-directive.sh` guards the floor (and caught the live 09-23 sweep)                                                                                                                                                | stale                                           |
