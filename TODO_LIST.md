...
| ------------------------------------------------ | ---------- | ------ | ------ | ------------------------------------------------------------------------ |
| Release v0.3.0 (bump Version, date CHANGELOG, tag) | 🔴 `TODO` | High   | 45min  | The 1% → 51%: all session features have zero value unreleased            |
...
| Example app v2 (auth/metrics/trend env toggles)  | 🔴 `TODO` | Medium | 60min  | Onboarding for v0.3.0 features                                           |
